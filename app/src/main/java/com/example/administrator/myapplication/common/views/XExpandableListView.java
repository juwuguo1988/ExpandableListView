...
public class XExpandableListView extends ExpandableListView implements OnScrollListener {
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if(scrollState == SCROLL_STATE_IDLE && isScrollToBottom && !mPullLoading) {
			startLoadMore();
		}
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		isScrollToBottom = lastVisiblePosition == totalItemCount - 1;
		if (mScrollListener != null) {
	...
	private void initWithContext(Context context) {
		...
		if (mHeaderTimeView.getText().equals("") || mHeaderTimeView.getText().equals(null)) {
